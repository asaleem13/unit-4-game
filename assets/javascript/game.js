...
var losses = 0;
var crystalTotal = 0;
var randomNumber = Math.floor(Math.random() * 119) + 1; // make this between 19 and 120
var crystal1point = Math.floor(Math.random() * 11) + 1; // make this more than 0
var crystal2point = Math.floor(Math.random() * 11) + 1;
var crystal3point = Math.floor(Math.random() * 11) + 1;
var crystal4point = Math.floor(Math.random() * 11) + 1;
